...
function ComboboxContent({
  ...
  if (!portal) {
    return (
      <>
        <span ref={setInlineContainer} style={{ position: "absolute" }} />
  ...
  return (
    <ComboboxPrimitive.Portal>{positioner}</ComboboxPrimitive.Portal>
  )
}
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-none focus:outline-none focus-visible:outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
